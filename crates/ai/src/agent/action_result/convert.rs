...
fn convert_completion_status(
    ...
    match status {
        computer_use::RecordingCompletionStatus::Complete => CompletionStatus::Complete,
        computer_use::RecordingCompletionStatus::Incomplete => CompletionStatus::Incomplete,
    }
}
